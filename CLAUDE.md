...
Track 디렉토리에 문서가 2개 이상 생성될 때, **INDEX.md**를 자동 생성/업데이트한다.
...
| 문서 | 설명 | 읽는 순서 |
|------|------|----------|
| WORK-SPEC.md | 작업 명세서 - 무엇을 왜 만드는지 | 1 |
| ARCHITECTURE.md | 시스템 구조 - 어떻게 구성되는지 | 2 |
| SPEC.md | 기능 명세 - 구체적으로 어떻게 동작하는지 | 3 |
| QA-SCENARIOS.md | QA 시나리오 - 어떻게 검증하는지 | 4 |
| SELF-REVIEW.md | 코드 리뷰 결과 | 5 |
