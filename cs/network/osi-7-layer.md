...
![OSI 7계층 구조](./images/osi-7-layer-structure.svg)
...
![데이터 링크 계층 프레임](./images/osi-frame.svg)
...
![네트워크 계층 패킷](./images/osi-packet.svg)
...
**라우팅**: 최적 경로 선택 (예: 서울 → 대전 → 부산 vs 서울 → 대구 → 부산)

#### 4계층: 전송 계층 (Transport Layer)

**역할**: 종단 간(End-to-End) 신뢰성 있는 전송

![전송 계층 세그먼트](./images/osi-segment.svg)
...
![캡슐화와 역캡슐화](./images/osi-encapsulation.svg)

### TCP/IP 4계층과 비교

![OSI vs TCP/IP](./images/osi-tcpip-compare.svg)
