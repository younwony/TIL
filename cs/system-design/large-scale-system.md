...
> `[4] 심화` · 선수 지식: [확장성](./scalability.md), [가용성](./availability.md), [일관성](./consistency.md)
...
- **면접**: 시스템 설계 면접은 모든 대기업의 필수 과정. 종합적 사고력 평가
- **기반 지식**: 확장성, 가용성, 일관성 등 모든 개념을 통합하는 메타 지식
...
![대규모 시스템 아키텍처](./images/large-scale-architecture.svg)
...
![서킷브레이커 상태 전이](./images/circuit-breaker.svg)
...
| 문서 | 연관성 | 난이도 |
|------|--------|--------|
| [확장성](./scalability.md) | 수평/수직 확장 전략 | 입문 |
| [가용성](./availability.md) | 고가용성 아키텍처 | 입문 |
| [일관성](./consistency.md) | CAP 정리와 일관성 모델 | 중급 |
| [캐싱](./caching.md) | 성능 최적화 전략 | 중급 |
| [메시지 큐](./message-queue.md) | 비동기 처리와 확장 | 중급 |
| [서킷브레이커](./circuit-breaker.md) | 장애 격리 패턴 | 심화 |
| [Kubernetes](./kubernetes.md) | 컨테이너 오케스트레이션 | 심화 |
