...
![일관성 모델 스펙트럼](./images/consistency-models.svg)
...
![동기식 레플리케이션](./images/consistency-sync-replication.svg)
...
![비동기식 레플리케이션](./images/consistency-async-replication.svg)
...
![CAP 정리](./images/consistency-cap.svg)
