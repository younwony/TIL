...
- **면접**: "캐시 전략 선택", "캐시 스탬피드 해결" 등 실무 경험 확인 질문
- **기반 지식**: Redis, Memcached 등 NoSQL 기술의 기초
...
![캐시 계층 구조](./images/cache-layers.svg)
...
![Cache-Aside 패턴](./images/cache-aside.svg)
...
![Write-Through 패턴](./images/cache-write-through.svg)
...
![Write-Behind 패턴](./images/cache-write-behind.svg)
...
![Write-Around 패턴](./images/cache-write-around.svg)
...
| 문서 | 연관성 | 난이도 |
|------|--------|--------|
| [확장성](./scalability.md) | 캐싱을 통한 DB 부하 분산 | 입문 |
| [일관성](./consistency.md) | 캐시와 DB 간 일관성 유지 | 중급 |
| [선착순 쿠폰 시스템](./flash-sale-system.md) | Redis 원자 연산 활용 예시 | 심화 |
| [대규모 시스템 설계](./large-scale-system.md) | 캐시 레이어를 포함한 전체 아키텍처 | 심화 |
