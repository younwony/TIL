...
![Kubernetes 아키텍처](./images/k8s-architecture.svg)
...
![Kubernetes Service Types](./images/k8s-service-types.svg)
...
![Kubernetes Ingress](./images/k8s-ingress.svg)
...
![Kubernetes Storage Architecture](./images/k8s-storage.svg)
...
![Rolling Update 과정](./images/k8s-rolling-update.svg)
