...
![서킷브레이커 마인드맵](./images/circuit-breaker-mindmap.svg)
...
![서킷브레이커 아키텍처](./images/circuit-breaker-architecture.svg)
...
![서킷브레이커 상태 전환](./images/circuit-breaker-state.svg)
...
![서킷브레이커 시퀀스](./images/circuit-breaker-sequence.svg)
