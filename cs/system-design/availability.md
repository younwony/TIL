...
![Active-Standby vs Active-Active](./images/availability-active-standby.svg)

**Active-Standby 장점**: 비용 절감 (Standby는 유휴 상태)
**Active-Standby 단점**: Standby 리소스 낭비, 전환 시간 필요

**Active-Active 장점**: 리소스 효율적, 즉시 전환
**Active-Active 단점**: 데이터 동기화 복잡, 비용 높음

**계층별 이중화:**

![계층별 이중화 구조](./images/availability-redundancy.svg)
...
![페일오버 시퀀스](./images/availability-failover.svg)
...
![헬스체크 계층별 전략](./images/availability-healthcheck.svg)
...
![SLA/SLO/SLI 관계](./images/availability-sla-slo-sli.svg)
