...
![M x N 문제 - 기존 방식](./images/mxn-problem-before.svg)

3개 AI × 5개 도구 = 15개 통합 코드 필요

**MCP 방식: M + N 통합만 필요**

![M x N 문제 - MCP 방식](./images/mxn-problem-after.svg)
...
![MCP 아키텍처](./images/mcp-architecture.svg)
...
![MCP 연결 수립](./images/mcp-connection.svg)

#### 도구 호출

![MCP 도구 호출](./images/mcp-tool-call.svg)
...
![API 방식](./images/api-vs-mcp-api.svg)

**MCP: LLM이 도구를 선택**

![MCP 방식](./images/api-vs-mcp-mcp.svg)
