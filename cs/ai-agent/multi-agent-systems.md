...
![Supervisor Pattern](./images/supervisor-pattern.svg)
...
![Adaptive Agent Network](./images/adaptive-network.svg)
...
![Orchestrator-Workers Pattern](./images/orchestrator-workers.svg)
...
![MCP + A2A 협력](./images/mcp-a2a-protocol.svg)
...
![Multi-Agent 인프라 아키텍처](./images/multi-agent-infra.svg)
