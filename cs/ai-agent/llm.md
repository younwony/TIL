...
![Transformer 구조](./images/transformer-architecture.svg)
...
![Self-Attention 예시](./images/self-attention.svg)
...
![토큰화 과정](./images/tokenization.svg)
...
![LLM 학습 과정](./images/llm-training.svg)

### 추론 (Inference)

학습된 모델을 사용하여 응답을 생성하는 과정입니다.

![LLM 추론 과정](./images/llm-inference.svg)
